...
const Info = () => {
    return ( 
        <div style={{height:'100%',minHeight:'100vh' }} className="parent-container text-center p-5  ">
          ...
          <img className="img1 mx-auto m-2" src={mern2} alt="Mern stack example" height="auto" width="250"></img>
          <h2>THE MERN STACK</h2>
          <p className='w-75 mx-auto p-2'>The MERN Stack is a Javascript Stack that is used for easier and faster deployment of full-stack web applications. 
             <br></br>
